...
OBJC_PUBLIC
EXCEPTION_DISPOSITION
__gnustep_objcxx_personality_v0 (PEXCEPTION_RECORD ms_exc, void *this_frame,
			     PCONTEXT ms_orig_context,
			     PDISPATCHER_CONTEXT ms_disp)
{
  return _GCC_specific_handler (ms_exc, this_frame, ms_orig_context,
...
OBJC_PUBLIC
void objc_exception_rethrow(void* exc)
{
    __cxa_rethrow();
    __builtin_trap();
}
