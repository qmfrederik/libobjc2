...
#define PrintExceptions 1
#define PrintExceptionThrow 1
...
// forward declaration
// objc_typeinfo OBJC_EHTYPE_id;

OBJC_PUBLIC
const void *objc_ehtype_vtable[] = {
    nil,  // typeinfo's vtable? - fixme 
    // TODO
    nil, // (void*)&OBJC_EHTYPE_id,  // typeinfo's typeinfo - hack
...
OBJC_PUBLIC
_Unwind_Reason_Code 
__gnustep_objc_personality_v0(int version,
                      _Unwind_Action actions,
                      uint64_t exceptionClass,
                      struct _Unwind_Exception *exceptionObject,
                      struct _Unwind_Context *context)
{
    return __objc_personality_v0(version, actions, exceptionClass, exceptionObject, context);
}

extern "C" 
OBJC_PUBLIC
_Unwind_Reason_Code 
__gnustep_objcxx_personality_v0(int version,
                      _Unwind_Action actions,
                      uint64_t exceptionClass,
                      struct _Unwind_Exception *exceptionObject,
                      struct _Unwind_Context *context)
...
void objc_exception_throw(id obj)
{
    ...
    exc->tinfo.cls_unremapped = obj ? obj->isa : Nil;
